...
/**
 * 圆弧仪表盘2控件 作者:feiyangqingyun(QQ:517216493) 2018-8-30
 * 1:可设置范围值,支持负数值
 * 2:可设置精确度,最大支持小数点后3位
 * 3:可设置大刻度数量/小刻度数量
 * 4:可设置开始旋转角度/结束旋转角度
...
class QDESIGNER_WIDGET_EXPORT GaugeArc2 : public QWidget
#else
class GaugeArc2 : public QWidget
#endif
...
public:
    explicit GaugeArc2(QWidget *parent = 0);
    ~GaugeArc2();
