...
void Widget::initWid()
{
    ui->W_1->setHidden(true);
    ui->W_2->setHidden(true);
    ui->W_3->setHidden(true);
    ui->W_4->setHidden(true);

    ui->N_1->setHidden(true);
    ui->N_2->setHidden(true);
    ui->N_3->setHidden(true);
    ui->N_4->setHidden(true);
