 ...
 * @return
 */
QString MachineCode::getWMIHWInfo(int type)
{
    QString hwInfo=("");
    QStringList sqlCmd;
    sqlCmd.clear();
 ...
 * @return
 */
QString MachineCode::getHDLogicalID()
{
 ...
 * @return
 */
QString MachineCode::getCPUManID()
{
    //用来存储信息
    DWORD deax;
    DWORD debx;
 ...
 * @return
 */
QString MachineCode::getMachineCode(int type)
{
    QString machineInfo=("");
